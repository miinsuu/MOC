...
import com.momeokji.moc.RecyclerViewAdapter.Adapter_menuList;
import com.momeokji.moc.RecyclerViewAdapter.Adapter_shopList;
import com.momeokji.moc.data.Shop;

public class ShopPage extends AppCompatActivity {

    private Adapter_menuList adapter;                                                           // menulist를 위한 리사이클러뷰 어딥터
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new Adapter_menuList();                                                       // 어댑터 등록
